...
<b-container>
    ...
    <b-row>
        ...
        <b-col class="h-100" cols="12" lg="5">
            <h3 class="text-primary">Property Condition</h3>
    ...
    <b-row>
        ...
        <b-col class="h-100" cols="12" lg="5">
            ...
            <div>
                <b-form-textarea id="textarea-state" v-model="text" :state="null" placeholder="Enter at least 10 characters" rows="3"></b-form-textarea>
            </div>
        </b-col>
    </b-row>
    <b-row>
